"""
Adapted from https://github.com/anugrahchemparathy/ContrastiveLearning/blob/main/ldcl/tools/device.py

Goal: make it possible to use M1 for gpu acceleration in local training.
"""
